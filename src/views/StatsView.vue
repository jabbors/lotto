<template>
  ...
  <p><b>Vinster</b></p>
  <p>Om man alltid hade lagt en rad me de sju mest förekommande nummren (dvs <span v-if="dataTopSevenNumbers">{{
    dataTopSevenNumbers.toString() }}</span>) skulle man genom tiderna ha haft:</p>
  ...
  <p>I tabellen nedan har jag listat hur många unika kombinationer av 7, 6, 5, 4, och 3 nummror man kan skapa bland 40
    nummror. Dessutom har jag listat hur många av kombinationerna som redan har förekommit om man för varje rad som
    dragits sedan 1987 skapar unika kombinationer av 7, 6, 5, 4, och 3 nummror.</p>
  ...
  <p>Det finns totalt 18643560 st unika rader. Då en rad kostar 1,0 € skulle det kosta 18643560 € att gardera alla
    rader. Om man en godtycklig vecka garderade alla rader skulle det ge dig följande vinstfördelning:</p>
  <table>
    <tbody>
      <tr>
